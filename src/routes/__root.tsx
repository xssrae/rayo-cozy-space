...
import { ImportAssistant } from "@/features/workspace/import-assistant";
    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6">
          <Link
            to="/"
            search={{ skill: undefined, tag: undefined }}
    ...
    head: () => ({
      meta: [
        ...
        { title: "Rayo Plan" },
        {
          name: "description",
          content:
            "Um espaço tranquilo para organizar projetos, tarefas e habilidades.",
        },
        { name: "author", content: "Rayo Plan" },
        { property: "og:title", content: "Rayo Plan" },
        {
